...
# ACDS 13.0sp1 232 win32 2022.05.29.21:22:53
...
ensure_lib                                                                                   ./libraries/PIN_SAIDA                                                                        
vmap       PIN_SAIDA                                                                         ./libraries/PIN_SAIDA                                                                        
ensure_lib                                                                                   ./libraries/PIN_ENTRADA                                                                      
vmap       PIN_ENTRADA                                                                       ./libraries/PIN_ENTRADA                                                                      
...
alias com {
  ...
  vcom  "$QSYS_SIMDIR/Nios_tb/simulation/submodules/Nios_nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo.vho" -work nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo
  ...
  vcom  "$QSYS_SIMDIR/Nios_tb/simulation/submodules/Nios_sysid_qsys_0.vho"                                                                      -work sysid_qsys_0                                                                     
  vcom  "$QSYS_SIMDIR/Nios_tb/simulation/submodules/Nios_PIN_SAIDA.vhd"                                                                         -work PIN_SAIDA                                                                        
  vcom  "$QSYS_SIMDIR/Nios_tb/simulation/submodules/Nios_PIN_ENTRADA.vhd"                                                                       -work PIN_ENTRADA                                                                      
  ...
  vcom  "$QSYS_SIMDIR/Nios_tb/simulation/submodules/Nios_nios2_qsys_0.vhd"                                                                      -work nios2_qsys_0                                                                     
  ...
  vcom  "$QSYS_SIMDIR/Nios_tb/simulation/submodules/nios_nios2_qsys_0_jtag_debug_module_translator.vhd"                                         -work Nios_inst                                                                        
  vcom  "$QSYS_SIMDIR/Nios_tb/simulation/submodules/nios_sysid_qsys_0_control_slave_translator.vhd"                                             -work Nios_inst                                                                        
  vcom  "$QSYS_SIMDIR/Nios_tb/simulation/submodules/nios_pin_saida_s1_translator.vhd"                                                           -work Nios_inst                                                                        
  vcom  "$QSYS_SIMDIR/Nios_tb/simulation/submodules/nios_pin_entrada_s1_translator.vhd"                                                         -work Nios_inst                                                                        
  vcom  "$QSYS_SIMDIR/Nios_tb/simulation/submodules/nios_jtag_uart_0_avalon_jtag_slave_translator.vhd"                                          -work Nios_inst                                                                        
  vcom  "$QSYS_SIMDIR/Nios_tb/simulation/submodules/nios_onchip_memory2_0_s1_translator.vhd"                                                    -work Nios_inst                                                                        
  vcom  "$QSYS_SIMDIR/Nios_tb/simulation/submodules/nios_nios2_qsys_0_instruction_master_translator.vhd"                                        -work Nios_inst                                                                        
  vcom  "$QSYS_SIMDIR/Nios_tb/simulation/submodules/nios_nios2_qsys_0_data_master_translator.vhd"                                               -work Nios_inst                                                                        
...
alias elab {
  echo "\[exec\] elab"
  vsim +access +r  -t ps -L work -L irq_mapper -L rsp_xbar_mux -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux -L rst_controller -L id_router -L addr_router -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent -L nios2_qsys_0_instruction_master_translator_avalon_universal_master_0_agent -L nios2_qsys_0_jtag_debug_module_translator -L nios2_qsys_0_instruction_master_translator -L sysid_qsys_0 -L PIN_SAIDA -L PIN_ENTRADA -L jtag_uart_0 -L onchip_memory2_0 -L nios2_qsys_0 -L Nios_inst_clk_bfm -L Nios_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  vsim -dbg -O2 +access +r -t ps -L work -L irq_mapper -L rsp_xbar_mux -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux -L rst_controller -L id_router -L addr_router -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent -L nios2_qsys_0_instruction_master_translator_avalon_universal_master_0_agent -L nios2_qsys_0_jtag_debug_module_translator -L nios2_qsys_0_instruction_master_translator -L sysid_qsys_0 -L PIN_SAIDA -L PIN_ENTRADA -L jtag_uart_0 -L onchip_memory2_0 -L nios2_qsys_0 -L Nios_inst_clk_bfm -L Nios_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii $TOP_LEVEL_NAME
}
