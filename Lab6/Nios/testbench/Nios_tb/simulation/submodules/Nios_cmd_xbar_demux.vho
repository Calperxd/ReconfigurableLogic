...
--synthesis_resources = 
 ...
 ENTITY  Nios_cmd_xbar_demux IS 
	 ...
	 ( 
		 ...
		 src2_data	:	OUT  STD_LOGIC_VECTOR (86 DOWNTO 0);
		 ...
		 src4_data	:	OUT  STD_LOGIC_VECTOR (86 DOWNTO 0);
 ...
 ARCHITECTURE RTL OF Nios_cmd_xbar_demux IS
	 ...
	 SIGNAL  s_wire_nios_cmd_xbar_demux_wideor0_13_dataout :	STD_LOGIC;
 ...
 BEGIN
	...
	s_wire_nios_cmd_xbar_demux_wideor0_13_dataout <= (((((wire_w_lg_w_sink_channel_range1w2w(0) OR wire_w_lg_w_sink_channel_range3w4w(0)) OR wire_w_lg_w_sink_channel_range6w7w(0)) OR wire_w_lg_w_sink_channel_range9w10w(0)) OR wire_w_lg_w_sink_channel_range12w13w(0)) OR wire_w_lg_w_sink_channel_range15w16w(0));
	sink_ready <= s_wire_nios_cmd_xbar_demux_wideor0_13_dataout;
