...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/Nios_tb/simulation/submodules/Nios_rsp_xbar_demux.vho"                                                                    -work rsp_xbar_demux                                                                   
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/Nios_tb/simulation/submodules/Nios_nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo.vho" -work nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo
  vhdlan -xlrm "$QSYS_SIMDIR/Nios_tb/simulation/submodules/Nios_sysid_qsys_0.vho"                                                                      -work sysid_qsys_0                                                                     
  vhdlan -xlrm "$QSYS_SIMDIR/Nios_tb/simulation/submodules/Nios_PIN_SAIDA.vhd"                                                                         -work PIN_SAIDA                                                                        
  vhdlan -xlrm "$QSYS_SIMDIR/Nios_tb/simulation/submodules/Nios_PIN_ENTRADA.vhd"                                                                       -work PIN_ENTRADA                                                                      
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/Nios_tb/simulation/submodules/Nios_nios2_qsys_0.vhd"                                                                      -work nios2_qsys_0                                                                     
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/Nios_tb/simulation/submodules/nios_nios2_qsys_0_jtag_debug_module_translator.vhd"                                         -work Nios_inst                                                                        
  vhdlan -xlrm "$QSYS_SIMDIR/Nios_tb/simulation/submodules/nios_sysid_qsys_0_control_slave_translator.vhd"                                             -work Nios_inst                                                                        
  vhdlan -xlrm "$QSYS_SIMDIR/Nios_tb/simulation/submodules/nios_pin_saida_s1_translator.vhd"                                                           -work Nios_inst                                                                        
  vhdlan -xlrm "$QSYS_SIMDIR/Nios_tb/simulation/submodules/nios_pin_entrada_s1_translator.vhd"                                                         -work Nios_inst                                                                        
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/Nios_tb/simulation/submodules/nios_nios2_qsys_0_instruction_master_translator.vhd"                                        -work Nios_inst                                                                        
  vhdlan -xlrm "$QSYS_SIMDIR/Nios_tb/simulation/submodules/nios_nios2_qsys_0_data_master_translator.vhd"                                               -work Nios_inst                                                                        
