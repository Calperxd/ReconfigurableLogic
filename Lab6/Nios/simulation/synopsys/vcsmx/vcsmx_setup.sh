...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/submodules/Nios_PIN_SAIDA.vhd"                                                                         -work PIN_SAIDA                                                                        
  vhdlan -xlrm "$QSYS_SIMDIR/submodules/Nios_PIN_ENTRADA.vhd"                                                                       -work PIN_ENTRADA                                                                      
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/nios_nios2_qsys_0_jtag_debug_module_translator.vhd"                                                                                                                                           
  vhdlan -xlrm "$QSYS_SIMDIR/nios_sysid_qsys_0_control_slave_translator.vhd"                                                                                                                                               
  vhdlan -xlrm "$QSYS_SIMDIR/nios_pin_saida_s1_translator.vhd"                                                                                                                                                             
  vhdlan -xlrm "$QSYS_SIMDIR/nios_pin_entrada_s1_translator.vhd"                                                                                                                                                           
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/nios_nios2_qsys_0_instruction_master_translator.vhd"                                                                                                                                          
  vhdlan -xlrm "$QSYS_SIMDIR/nios_nios2_qsys_0_data_master_translator.vhd"                                                                                                                                                 
fi
