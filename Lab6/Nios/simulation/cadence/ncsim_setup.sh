...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/Nios_rsp_xbar_demux.vho"                                                                    -work rsp_xbar_demux                                                                    -cdslib ./cds_libs/rsp_xbar_demux.cds.lib                                                                   
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/Nios_nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo.vho" -work nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -cdslib ./cds_libs/nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo.cds.lib
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/Nios_sysid_qsys_0.vho"                                                                      -work sysid_qsys_0                                                                      -cdslib ./cds_libs/sysid_qsys_0.cds.lib                                                                     
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/Nios_PIN_SAIDA.vhd"                                                                         -work PIN_SAIDA                                                                         -cdslib ./cds_libs/PIN_SAIDA.cds.lib                                                                        
  ncvhdl -v93 "$QSYS_SIMDIR/submodules/Nios_PIN_ENTRADA.vhd"                                                                       -work PIN_ENTRADA                                                                       -cdslib ./cds_libs/PIN_ENTRADA.cds.lib                                                                      
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/nios_nios2_qsys_0_jtag_debug_module_translator.vhd"                                                                                                                                                                                                                                                        
  ncvhdl -v93 "$QSYS_SIMDIR/nios_sysid_qsys_0_control_slave_translator.vhd"                                                                                                                                                                                                                                                            
  ncvhdl -v93 "$QSYS_SIMDIR/nios_pin_saida_s1_translator.vhd"                                                                                                                                                                                                                                                                          
  ncvhdl -v93 "$QSYS_SIMDIR/nios_pin_entrada_s1_translator.vhd"                                                                                                                                                                                                                                                                        
  ncvhdl -v93 "$QSYS_SIMDIR/nios_jtag_uart_0_avalon_jtag_slave_translator.vhd"                                                                                                                                                                                                                                                         
  ncvhdl -v93 "$QSYS_SIMDIR/nios_onchip_memory2_0_s1_translator.vhd"                                                                                                                                                                                                                                                                   
  ncvhdl -v93 "$QSYS_SIMDIR/nios_nios2_qsys_0_instruction_master_translator.vhd"                                                                                                                                                                                                                                                       
  ncvhdl -v93 "$QSYS_SIMDIR/nios_nios2_qsys_0_data_master_translator.vhd"                                                                                                                                                                                                                                                              
fi
