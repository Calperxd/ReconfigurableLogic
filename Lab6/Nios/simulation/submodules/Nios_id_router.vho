...
--synthesis_resources = 
 ...
 ARCHITECTURE RTL OF Nios_id_router IS
	 ...
	 SIGNAL  s_wire_nios_id_router_src_channel_1_280_dataout :	STD_LOGIC;
 BEGIN

	wire_w262w(0) <= NOT s_wire_nios_id_router_src_channel_1_280_dataout;
	s_wire_nios_id_router_src_channel_1_280_dataout <= (((NOT sink_data(74)) AND (NOT sink_data(75))) AND (NOT sink_data(76)));
	sink_ready <= src_ready;
	src_channel <= ( "0" & "0" & "0" & "0" & s_wire_nios_id_router_src_channel_1_280_dataout & wire_w262w);
